...
import { IconEmail, IconPassword } from "../MovieList/Icons";
...
export const useUserStore = create(
  persist(
    (set) => ({
      ...
      authority: null,
      isLoggedIn: false,
      login: (user, token, authority) =>
        set({ user, token, authority, isLoggedIn: true }), // 로그인 처리
      logout: () =>
        set({ user: null, token: null, authority: null, isLoggedIn: false }), // 로그아웃 처리
    }),
    {
